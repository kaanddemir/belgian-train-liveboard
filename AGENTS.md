...
npm test          # Vitest unit tests (Node, offline)
...
tests only. Layout, focus, history, browser APIs, the map and live iRail
data remain browser/manual QA. There is no lint script.
...
9. `npm test` and `npm run build` succeed.
